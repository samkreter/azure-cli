...
def load_arguments(self, _):
    ...
    with self.argument_context('container exec') as c:
        c.argument('container_name', help='The container name where to exec the command. If omitted, the first container in the container group will be chosen')
        c.argument('exec_command', help='The command to run within the container')
